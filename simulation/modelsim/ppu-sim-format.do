...
add wave -noupdate -radix hexadecimal /ppu_sim/read_address
add wave -noupdate /ppu_sim/ppu_mem_read_enable
add wave -noupdate -radix hexadecimal /ppu_sim/write_address
add wave -noupdate /ppu_sim/we
add wave -noupdate -radix hexadecimal /ppu_sim/ram_in
add wave -noupdate -radix symbolic /ppu_sim/ram_out
...
add wave -noupdate -color Magenta -radix hexadecimal /ppu_sim/vx
add wave -noupdate -color Magenta -radix hexadecimal /ppu_sim/vy
add wave -noupdate -color Magenta -radix hexadecimal /ppu_sim/I
add wave -noupdate -color Magenta -radix hexadecimal /ppu_sim/n
...
add wave -noupdate /ppu_sim/ram/mem
